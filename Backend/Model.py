...
print("API Key loaded:", CohereAPIKey)
...
# Contextual chat history for few-shot learning
ChatHistory = [
    ...
    {"role": "Chatbot", "message": "general what is is today's date, reminder 11:00pm 5th aug dancing performance"},
    {"role": "User", "message": "chat with me."},
    {"role": "Chatbot", "message": "general chat with me."}
]
messages =[]
# Instruction preamble for guiding model behavior
preamble = """
...
def FirstLayerDMM(prompt: str = "test"):
    try:
        # Send the prompt to Cohere's chat stream
...
if __name__ == "__main__":
    while True:
        ...
        if user_input.strip().lower() in ["exit", "quit", "bye"]:
            print("[cyan]exit[/cyan]")
            break
        results = FirstLayerDMM(user_input)
        for r in results:
            print(f"[green]{r}[/green]")
